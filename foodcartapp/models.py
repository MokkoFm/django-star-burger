...
class Order(models.Model):
    ...
    status = models.CharField(
        max_length=3, choices=STATUS, default='NO', verbose_name='статус')
    ...
    delivered_at = models.DateTimeField(
        verbose_name='время доставки заказа клиенту', null=True, blank=True)
...
class OrderProductItem(models.Model):
    ...
    product = models.ForeignKey(
        ...
        verbose_name='продукт в заказе', related_name='order')
    quantity = models.IntegerField(validators=[MinValueValidator(
        1), MaxValueValidator(25)], verbose_name='количество')
